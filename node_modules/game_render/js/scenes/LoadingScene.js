...
export default class LoadingScene extends Phaser.Scene {
    ...
    preload() {
        this.load.image('startScene', '../../assets/scene/start.jpg');
        this.load.image('win', '../../assets/scene/win.png');
        this.load.image('lose', '../../assets/scene/lose.png');
        this.load.image('draw', '../../assets/scene/draw.png');
        ...
        this.load.image('powerup_bombs', '../../assets/item/powerup_bombs.png');
        this.load.image('powerup_flames', '../../assets/item/powerup_flames.png');
        this.load.image('powerup_speed', '../../assets/item/powerup_speed.png');
        this.load.image('powerup_stars', '../../assets/item/powerup_stars.png');

        this.load.image('star_icon', '../../assets/info/star.png');
        this.load.image('bomb_icon', '../../assets/info/bomb.png');
        this.load.image('brick_icon', '../../assets/info/brick.png');
        this.load.image('flame_icon', '../../assets/info/flame.png');
        this.load.image('roller_icon', '../../assets/info/roller.png');
        this.load.image('paw_icon', '../../assets/info/paw.png');
        this.load.image('flag_1', '../../assets/info/flag_1.png');
        this.load.image('flag_2', '../../assets/info/flag_2.png');
    }
