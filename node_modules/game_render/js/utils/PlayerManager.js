...
export default class PlayerManager {
    constructor(context, team, dataPlayer) {
        ...
        this.bomberman = context.add.existing(new Character(context,
            (dataPlayer.bomber.x + constant.ORIGIN_X) * constant.SCALE,
            (dataPlayer.bomber.y + constant.ORIGIN_Y) * constant.SCALE,
            'bomberman_' + team));
        this.monster = context.add.existing(new Character(context,
            (dataPlayer.enemy.x + constant.ORIGIN_X) * constant.SCALE,
            (dataPlayer.enemy.y + constant.ORIGIN_Y) * constant.SCALE,
            'monster_' + team));

        this.drawText(context, team);
        this.setData(dataPlayer);
    }
    ...
    setData(dataPlayer) {
        ...
        this.bomberman.setNewXY(
            (dataPlayer.bomber.x + 8 + constant.ORIGIN_X) * constant.SCALE,
            (dataPlayer.bomber.y + 8 + constant.ORIGIN_Y) * constant.SCALE);
        this.monster.setNewXY(
            (dataPlayer.enemy.x + 8 + constant.ORIGIN_X) * constant.SCALE,
            (dataPlayer.enemy.y + 8 + constant.ORIGIN_Y) * constant.SCALE);
    }
